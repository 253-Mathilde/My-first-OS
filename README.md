...
I used a image from pinterest in my graphics(the "map" of Neverland) https://pin.it/68t2L17HO 
  ...
  Check out my other project (My personal Website) because I used parts of that code again
  and every project I do is similar to this one from the basis ( I know it is similar becaus eof the programming 
  yk but I use this as a help if I forget something you know like how did I do that back than)
  Come back in some time to read the final README!!! Thanksssss
